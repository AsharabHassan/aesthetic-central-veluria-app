      ...
      */}
      ...
      <section className="animate-fade-scale" style={{ animationDelay: "70ms" }}>
        <VeluriaEducation
          report
          programme={programme}
          preservedCount={preserve?.length ?? 0}
          cta={
            <PhoneConsultButton
              href={ctaHref("rejuvenation")}
              onClick={onBookingClick("rejuvenation")}
              label="Ask what is realistic for my skin"
            />
          }
        />
      </section>
            ...
            <div className="grid gap-6 sm:grid-cols-[1fr_auto] sm:items-center">
              <div>
                <p className="text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-gold-soft">
                  Free 15-minute results review
                </p>
                <h3 className="display mt-2 text-2xl text-white sm:text-3xl">
                  Turn your preview into a realistic plan
                </h3>
              ...
              <div className="flex flex-col items-start gap-2 sm:items-center">
                <PhoneConsultButton
                  ...
                  label="Review what is realistic for me"
                />
                <p className="text-xs text-white/60">
                  Your contact details are pre-filled.
                </p>
              </div>
            </div>
          </div>
        ...
        */}
        ...
        <div className="mt-6 flex flex-col items-center gap-2">
          <PhoneConsultButton
            ...
            label="Choose my free 15-minute review"
          />
          <p className="text-xs text-plum-mute">
